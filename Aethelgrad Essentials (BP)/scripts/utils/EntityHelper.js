 ...
 * Tier 3: entity.teleport({y: -256}) - Despawn by void if kill fails
 * 
...
/**
 * Removes entities by type within a radius
...
export function removeEntitiesByType(entityType, center, radius, dimension = "overworld") {
    try {
        ...
        console.error(`EntityHelper: Failed to remove entities by type ${entityType}:`, error)
        return 0
    }
}
