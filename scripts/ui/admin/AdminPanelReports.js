...
export async function showReports(player) {
    ...
    switch (res.selection) {
        case 0:
            ...
            break
        case 1:
            player.sendMessage("\u00A77\u00A7l\u00BB \u00A7cLogs: \u00A77This feature is not yet available.")
        ...
        case 2:
            ...
            break
        case 3:
            player.sendMessage("\u00A77\u00A7l\u00BB \u00A7cEconomy Logs: \u00A77This feature is not yet available.")
            await showReports(player)
            break
        case 4:
            player.sendMessage("\u00A77\u00A7l\u00BB \u00A7cChat Logs: \u00A77This feature is not yet available.")
            await showReports(player)
            break
        case 5:
...
async function showReportsList(player) {
    try {
        ...
        player.sendMessage("\u00A7c\u00A7l\u00BB \u00A77Failed to open report manager.")
        return
    }
}
...
async function showPlayerHistory(player) {
    try {
        ...
        const { showLogBrowser } = await import("../admin/LogUI.js")
        await showLogBrowser(player)
    } catch (e) {
        player.sendMessage(`\u00A7c\u00A7l\u00BB \u00A77Failed to open player activity logs.`)
        await showReports(player)
    }
}
