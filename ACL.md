...
We believe software freedom is a human right. Every developer, student, hobbyist,
and researcher should be able to study, modify, run, and share code without
...
1.1 You may use, copy, study, modify, and distribute the Work for any 
    **non-commercial purpose**, including personal hobby projects, academic 
    instruction, research at degree-granting institutions, and non-profit 
...
2.2 "Commercial Entity" means any person or organization with:
    (a) annual revenue exceeding $100,000 USD, or
...
2.4 "Developer Seat" means any individual (employee, contractor, or agent) who 
    ...
    Excludes pure code reviewers without write access, automated build systems, 
    and contractors under 40 hours per year.

2.5 "Annual Revenue" means the aggregate gross revenue of the entire corporate 
    group, including all parents, subsidiaries, and affiliates under common 
    control (>50% ownership). No tier-shopping through separate subsidiaries is 
    permitted.

2.6 "Output" means any data, API response, generated behavior, or result 
    produced by executing the Work.

================================================================================
ARTICLE 3 – MODIFICATION AND DISTRIBUTION
================================================================================
...
THE WORK IS PROVIDED "AS IS", WITHOUT ANY WARRANTIES OF ANY KIND, EXPRESS OR 
IMPLIED.
...
6.1 Severability, entire agreement, and standard provisions apply.
6.2 Failure to enforce any right does not waive it.

================================================================================
ARTICLE 7 – COMMERCIAL TERMS (ENFORCEMENT LAYER)
================================================================================

7.1 **Trial Period**
Commercial Entities receive a **40-day free production trial**. Use beyond 
40 days requires a paid commercial license, retroactive to first access.

7.2 **Commercial Use Requires License**
Any revenue-generating activity, monetized server, Marketplace content, or 
production deployment by a Commercial Entity requires a paid license.

7.3 **Pricing (Annual)**

| Tier                | Annual Revenue     | Base Usage | + Modification Rights |
|---------------------|--------------------|------------|-----------------------|
| Startup             | $100k – $2M        | $399       | $899                  |
| Professional        | $2M – $20M         | $999       | $1,799                |
...
years after the end of the license term.

7.5 **Compliance & Audit**
Commercial licensees must provide annual signed certification of revenue tier 
and Developer Seats. The Licensor may audit once per year with 30 days’ notice. 
If underreporting exceeds 5%, Licensee pays audit costs. Refusal to cooperate 
within 30 days allows court-ordered production at Licensee’s expense.
...
(b) remove all proprietary modifications and use the Work only under the 
    non-commercial terms of Articles 1–3.

All unpaid fees for the period prior to termination remain due and payable 
immediately. Upon termination, Licensee may request up to 90 days of transition 
use at 200% of then-applicable fees to migrate away. Licensor shall not 
unreasonably withhold such transition period.
